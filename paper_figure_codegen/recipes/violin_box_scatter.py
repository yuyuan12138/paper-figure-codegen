"""Combined violin, box, and scatter plot recipe — distribution comparison."""
...
class Recipe(BaseRecipe):
    ...
    def _build_data_loading(self, spec: FigureDataSpec) -> str:
        ...
        return (
            "\n"
            "    # TODO: Replace this example data with your real data.\n"
            '    group_names = ["Baseline", "Method A", "Ours"]\n'
            "    np.random.seed(42)\n"
            "    data = {\n"
            '        "Baseline": np.random.normal(0.72, 0.08, 50),\n'
            '        "Method A": np.random.normal(0.78, 0.07, 50),\n'
            '        "Ours": np.random.normal(0.85, 0.06, 50),\n'
            "    }\n"
            "    return group_names, data"
        )
